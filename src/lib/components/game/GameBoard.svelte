<script lang="ts">
	import { GamePhase, type Game } from "$lib/models/Game";
	import { Couple, GuessButton, Word } from ".";
    import { WordState, type Word as WordType } from '$lib/models/Word';
    ...
    let unit = 100.0 / (Math.ceil(game.wordCount / 2) + 4);
